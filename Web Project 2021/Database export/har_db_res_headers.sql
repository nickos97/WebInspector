...
--
-- Table structure for table `res_headers`
--

DROP TABLE IF EXISTS `res_headers`;
/*!40101 SET @saved_cs_client     = @@character_set_client */;
/*!50503 SET character_set_client = utf8mb4 */;
CREATE TABLE `res_headers` (
  `reshead_id` int NOT NULL,
  ...
  KEY `resheadid` (`reshead_id`),
  CONSTRAINT `resheadiid` FOREIGN KEY (`reshead_id`) REFERENCES `responses` (`res_id`)
