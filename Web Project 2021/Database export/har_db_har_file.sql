...
CREATE TABLE `har_file` (
  ...
  PRIMARY KEY (`har_id`),
  KEY `uid_idx` (`us_id`),
  CONSTRAINT `uid` FOREIGN KEY (`us_id`) REFERENCES `users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE
...
-- Dump completed on 2021-06-06 21:51:49
